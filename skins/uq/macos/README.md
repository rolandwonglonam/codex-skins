...
This copy opens with a UQ theme. It uses UQ Purple `#51247A`, official UQ logo assets, and a Great Court photo from UQ's official St Lucia campus page. It is a private local theme and is not endorsed by UQ or OpenAI.
...
# 3) The bundled UQ theme is now the default. Customization is optional.
~/.codex/codex-dream-skin-studio/scripts/customize-theme-macos.sh

# 4) Start / re-apply, verify, or restore via Desktop:
#    Codex UQ Skin.command
#    Codex UQ Skin - Customize.command
#    Codex UQ Skin - Verify.command
#    Codex UQ Skin - Restore.command
...
UQ brand use is governed by the [UQ Brand Policy](https://policies.uq.edu.au/document/view-current.php?id=113) and [Brand Procedure](https://policies.uq.edu.au/document/view-current.php?id=358). The logo files in this copy come from UQ's public static asset service. Public distribution still requires the applicable UQ approval.
