...
/bin/cp "$ROOT/assets/unimelb-old-quad.jpg" "$TMP/theme/background.jpg"
...
/usr/bin/env -u HOME /bin/bash -c '. "$1/scripts/common-macos.sh"; [ -n "$HOME" ] && [ "$SKIN_VERSION" = "1.0.0-unimelb1" ]' _ "$ROOT"
