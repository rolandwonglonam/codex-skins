...
if [ -z "${HOME:-}" ]; then
  ...
  if [ -z "$HOME" ]; then HOME="/Users/$CURRENT_USER"; fi
...
INSTALL_ROOT="$HOME/.codex/codex-harvard-skin-studio"
STATE_ROOT="$HOME/Library/Application Support/CodexDreamSkinStudio"
STATE_PATH="$STATE_ROOT/state.json"
THEME_BACKUP_PATH="$STATE_ROOT/theme-backup.json"
THEME_DIR="$STATE_ROOT/theme-harvard"
...
AUTO_INJECT_LOG="$STATE_ROOT/auto-inject.log"
AUTO_INJECT_ERROR_LOG="$STATE_ROOT/auto-inject-error.log"
CODEX_APP_JOB_LABEL="com.openai.codex-dream-skin-studio.app"
INJECTOR_JOB_LABEL="com.openai.codex-dream-skin-studio.injector"
AUTO_INJECT_JOB_LABEL="com.openai.codex-dream-skin-studio.auto-inject"
AUTO_INJECT_PLIST="$HOME/Library/LaunchAgents/$AUTO_INJECT_JOB_LABEL.plist"
EXPECTED_CODEX_TEAM_ID="${CODEX_EXPECTED_TEAM_ID:-2DC432GLL2}"
SKIN_VERSION="1.0.1-harvard2"
