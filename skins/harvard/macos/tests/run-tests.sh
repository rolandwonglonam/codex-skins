...
/bin/cp "$ROOT/assets/harvard-widener-library.jpg" "$TMP/theme/background.jpg"
...
/usr/bin/env -u HOME /bin/bash -c '. "$1/scripts/common-macos.sh"; [ -n "$HOME" ] && [ "$SKIN_VERSION" = "1.0.1-harvard2" ]' _ "$ROOT"
